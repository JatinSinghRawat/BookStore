                ...
                <div className=' order-2 md:order-1 w-full md:w-1/2 mt-6 md:mt-32'>
                    <div className='space-y-8'>
                        <h1 className='text-4xl font-bold'>
                            Hello, welcome here to learn something <span className='text-pink-600'>new everyday!!!</span></h1>
                        <p className='text-xl font-semibold'>
                            Free and Paid books availabe for you to learn<br></br>
                            things, you are curious about.<br></br>
